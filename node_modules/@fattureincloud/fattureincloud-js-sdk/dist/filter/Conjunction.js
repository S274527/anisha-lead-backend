 ...
 */
var Conjunction = exports["default"] = /*#__PURE__*/function (_Expression) {
  _inherits(Conjunction, _Expression);
  /**
  ...
  function Conjunction(left, right) {
    ...
    _this = _callSuper(this, Conjunction);
    /**
       * The left expression.
  ...
  _createClass(Conjunction, [{
    ...
    value: function buildQuery() {
      ...
      return "(".concat(this.left.buildQuery(), " and ").concat(this.right.buildQuery(), ")");
    }
