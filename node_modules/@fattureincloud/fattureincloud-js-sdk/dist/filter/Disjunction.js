 ...
 */
var Disjunction = exports["default"] = /*#__PURE__*/function (_Expression) {
  _inherits(Disjunction, _Expression);
  /**
  ...
  function Disjunction(left, right) {
    ...
    _this = _callSuper(this, Disjunction);
    /**
       * The left expression.
  ...
  _createClass(Disjunction, [{
    ...
    value: function buildQuery() {
      ...
      return "(".concat(this.left.buildQuery(), " or ").concat(this.right.buildQuery(), ")");
    }
