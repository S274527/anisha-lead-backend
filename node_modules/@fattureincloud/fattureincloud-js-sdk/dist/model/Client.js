...
var _PaymentTermsType = _interopRequireDefault(require("./PaymentTermsType"));
  ...
  _createClass(Client, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('contact_person')) {
          obj.contact_person = _ApiClient["default"].convertToType(data.contact_person, 'String');
        }
        ...
        if (data.hasOwnProperty('address_street')) {
          obj.address_street = _ApiClient["default"].convertToType(data.address_street, 'String');
        }
        ...
        if (data.hasOwnProperty('address_province')) {
          obj.address_province = _ApiClient["default"].convertToType(data.address_province, 'String');
        }
        if (data.hasOwnProperty('address_extra')) {
          obj.address_extra = _ApiClient["default"].convertToType(data.address_extra, 'String');
        }
        if (data.hasOwnProperty('country')) {
          obj.country = _ApiClient["default"].convertToType(data.country, 'String');
        }
        if (data.hasOwnProperty('country_iso')) {
          obj.country_iso = _ApiClient["default"].convertToType(data.country_iso, 'String');
        }
        if (data.hasOwnProperty('email')) {
          obj.email = _ApiClient["default"].convertToType(data.email, 'String');
        }
        if (data.hasOwnProperty('certified_email')) {
          obj.certified_email = _ApiClient["default"].convertToType(data.certified_email, 'String');
        }
        ...
        if (data.hasOwnProperty('default_payment_terms')) {
          obj.default_payment_terms = _ApiClient["default"].convertToType(data.default_payment_terms, 'Number');
        }
        if (data.hasOwnProperty('default_payment_terms_type')) {
          obj.default_payment_terms_type = _PaymentTermsType["default"].constructFromObject(data.default_payment_terms_type);
        }
        if (data.hasOwnProperty('default_payment_method')) {
          obj.default_payment_method = _PaymentMethod["default"].constructFromObject(data.default_payment_method);
        }
        ...
        if (data.hasOwnProperty('bank_iban')) {
          obj.bank_iban = _ApiClient["default"].convertToType(data.bank_iban, 'String');
        }
        if (data.hasOwnProperty('bank_swift_code')) {
          obj.bank_swift_code = _ApiClient["default"].convertToType(data.bank_swift_code, 'String');
        }
        if (data.hasOwnProperty('shipping_address')) {
          obj.shipping_address = _ApiClient["default"].convertToType(data.shipping_address, 'String');
        }
        ...
        if (data.hasOwnProperty('ei_code')) {
          obj.ei_code = _ApiClient["default"].convertToType(data.ei_code, 'String');
        }
        if (data.hasOwnProperty('discount_highlight')) {
          obj.discount_highlight = _ApiClient["default"].convertToType(data.discount_highlight, 'Boolean');
        }
        if (data.hasOwnProperty('default_discount')) {
          obj.default_discount = _ApiClient["default"].convertToType(data.default_discount, 'Number');
        }
        if (data.hasOwnProperty('has_intent_declaration')) {
          obj.has_intent_declaration = _ApiClient["default"].convertToType(data.has_intent_declaration, 'Boolean');
        }
        if (data.hasOwnProperty('intent_declaration_protocol_number')) {
          obj.intent_declaration_protocol_number = _ApiClient["default"].convertToType(data.intent_declaration_protocol_number, 'String');
        }
        if (data.hasOwnProperty('intent_declaration_protocol_date')) {
          obj.intent_declaration_protocol_date = _ApiClient["default"].convertToType(data.intent_declaration_protocol_date, 'Date');
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data.default_payment_method) {
        // data not null
        _PaymentMethod["default"].validateJSON(data.default_payment_method);
      }
      // ensure the json data is a string
