...
var _UserCompanyRole = _interopRequireDefault(require("./UserCompanyRole"));
 ...
 * @version 2.0.25
 */
var CompanyInfoAccessInfo = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>CompanyInfoAccessInfo</code>.
     * @alias module:model/CompanyInfoAccessInfo
     */
  function CompanyInfoAccessInfo() {
    _classCallCheck(this, CompanyInfoAccessInfo);
  ...
  /**
     ...
     */
  _createClass(CompanyInfoAccessInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('role')) {
          obj.role = _UserCompanyRole["default"].constructFromObject(data.role);
        }
        if (data.hasOwnProperty('permissions')) {
          obj.permissions = _Permissions["default"].constructFromObject(data.permissions);
        }
        if (data.hasOwnProperty('through_accountant')) {
          obj.through_accountant = _ApiClient["default"].convertToType(data.through_accountant, 'Boolean');
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.permissions) {
        // data not null
        _Permissions["default"].validateJSON(data.permissions);
      }
      return true;
    }
  }]);
  return CompanyInfoAccessInfo;
}();
/**
...
var _default = exports["default"] = CompanyInfoAccessInfo;