...
var _CompanyInfoPlanInfoFunctions = _interopRequireDefault(require("./CompanyInfoPlanInfoFunctions"));
var _CompanyInfoPlanInfoFunctionsStatus = _interopRequireDefault(require("./CompanyInfoPlanInfoFunctionsStatus"));
var _CompanyInfoPlanInfoLimits = _interopRequireDefault(require("./CompanyInfoPlanInfoLimits"));
 ...
 * @version 2.0.25
 */
var CompanyInfoPlanInfo = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>CompanyInfoPlanInfo</code>.
     * Company plan info
     * @alias module:model/CompanyInfoPlanInfo
     */
  function CompanyInfoPlanInfo() {
    _classCallCheck(this, CompanyInfoPlanInfo);
  ...
  /**
     ...
     */
  _createClass(CompanyInfoPlanInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('limits')) {
          obj.limits = _CompanyInfoPlanInfoLimits["default"].constructFromObject(data.limits);
        }
        if (data.hasOwnProperty('functions')) {
          obj.functions = _CompanyInfoPlanInfoFunctions["default"].constructFromObject(data.functions);
        }
        if (data.hasOwnProperty('functions_status')) {
          obj.functions_status = _CompanyInfoPlanInfoFunctionsStatus["default"].constructFromObject(data.functions_status);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.limits) {
        // data not null
        _CompanyInfoPlanInfoLimits["default"].validateJSON(data.limits);
      }
      // validate the optional field `functions`
      if (data.functions) {
        // data not null
        _CompanyInfoPlanInfoFunctions["default"].validateJSON(data.functions);
      }
      // validate the optional field `functions_status`
      if (data.functions_status) {
        // data not null
        _CompanyInfoPlanInfoFunctionsStatus["default"].validateJSON(data.functions_status);
      }
      return true;
    }
  }]);
  return CompanyInfoPlanInfo;
}();
/**
...
var _default = exports["default"] = CompanyInfoPlanInfo;