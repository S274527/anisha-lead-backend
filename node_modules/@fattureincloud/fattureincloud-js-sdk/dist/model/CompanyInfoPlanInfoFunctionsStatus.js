...
var _FunctionStatus = _interopRequireDefault(require("./FunctionStatus"));
 ...
 * @version 2.0.25
 */
var CompanyInfoPlanInfoFunctionsStatus = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>CompanyInfoPlanInfoFunctionsStatus</code>.
     * @alias module:model/CompanyInfoPlanInfoFunctionsStatus
     */
  function CompanyInfoPlanInfoFunctionsStatus() {
    _classCallCheck(this, CompanyInfoPlanInfoFunctionsStatus);
  ...
  /**
     ...
     */
  _createClass(CompanyInfoPlanInfoFunctionsStatus, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ts_digital')) {
          obj.ts_digital = _FunctionStatus["default"].constructFromObject(data.ts_digital);
        }
        if (data.hasOwnProperty('ts_pay')) {
          obj.ts_pay = _FunctionStatus["default"].constructFromObject(data.ts_pay);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.ts_digital) {
        // data not null
        _FunctionStatus["default"].validateJSON(data.ts_digital);
      }
      // validate the optional field `ts_pay`
      if (data.ts_pay) {
        // data not null
        _FunctionStatus["default"].validateJSON(data.ts_pay);
      }
      return true;
    }
  }]);
  return CompanyInfoPlanInfoFunctionsStatus;
}();
/**
...
var _default = exports["default"] = CompanyInfoPlanInfoFunctionsStatus;