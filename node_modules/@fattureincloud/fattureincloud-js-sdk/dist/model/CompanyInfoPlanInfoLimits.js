 ...
 * @version 2.0.25
 */
var CompanyInfoPlanInfoLimits = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>CompanyInfoPlanInfoLimits</code>.
     * Company plan limits
     * @alias module:model/CompanyInfoPlanInfoLimits
     */
  function CompanyInfoPlanInfoLimits() {
    _classCallCheck(this, CompanyInfoPlanInfoLimits);
  ...
  /**
     ...
     */
  _createClass(CompanyInfoPlanInfoLimits, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('clients')) {
          obj.clients = _ApiClient["default"].convertToType(data.clients, 'Number');
        }
        if (data.hasOwnProperty('suppliers')) {
          obj.suppliers = _ApiClient["default"].convertToType(data.suppliers, 'Number');
        }
        if (data.hasOwnProperty('products')) {
          obj.products = _ApiClient["default"].convertToType(data.products, 'Number');
        }
        if (data.hasOwnProperty('documents')) {
          obj.documents = _ApiClient["default"].convertToType(data.documents, 'Number');
        }
      }
      return obj;
    }
  ...
  return CompanyInfoPlanInfoLimits;
}();
/**
...
var _default = exports["default"] = CompanyInfoPlanInfoLimits;