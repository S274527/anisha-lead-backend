 ...
 * @version 2.0.25
 */
var CreateF24Request = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>CreateF24Request</code>.
     *
     * @alias module:model/CreateF24Request
     */
  function CreateF24Request() {
    _classCallCheck(this, CreateF24Request);
  ...
  /**
     ...
     */
  _createClass(CreateF24Request, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _F["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>CreateF24Request</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateF24Request</code>.
       */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _F["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
  return CreateF24Request;
}();
/**
 * @member {module:model/F24} data
 */
CreateF24Request.prototype.data = undefined;
var _default = exports["default"] = CreateF24Request;