 ...
 * @module model/CreatePaymentAccountRequest
 * @version 2.0.25
 */
var CreatePaymentAccountRequest = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>CreatePaymentAccountRequest</code>.
     * @alias module:model/CreatePaymentAccountRequest
     */
  function CreatePaymentAccountRequest() {
    _classCallCheck(this, CreatePaymentAccountRequest);
  ...
  /**
     ...
     */
  _createClass(CreatePaymentAccountRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _PaymentAccount["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>CreatePaymentAccountRequest</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePaymentAccountRequest</code>.
       */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _PaymentAccount["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = CreatePaymentAccountRequest;