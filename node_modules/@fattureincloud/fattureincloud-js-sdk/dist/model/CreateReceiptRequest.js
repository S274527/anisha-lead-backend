 ...
 * @version 2.0.25
 */
var CreateReceiptRequest = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>CreateReceiptRequest</code>.
     *
     * @alias module:model/CreateReceiptRequest
     */
  function CreateReceiptRequest() {
    _classCallCheck(this, CreateReceiptRequest);
  ...
  /**
     ...
     */
  _createClass(CreateReceiptRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('autocomplete_number')) {
          obj.autocomplete_number = _ApiClient["default"].convertToType(data.autocomplete_number, 'Boolean');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = CreateReceiptRequest;