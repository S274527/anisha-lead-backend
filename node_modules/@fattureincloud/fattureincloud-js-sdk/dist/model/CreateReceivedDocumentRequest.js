 ...
 * @version 2.0.25
 */
var CreateReceivedDocumentRequest = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>CreateReceivedDocumentRequest</code>.
     *
     * @alias module:model/CreateReceivedDocumentRequest
     */
  function CreateReceivedDocumentRequest() {
    _classCallCheck(this, CreateReceivedDocumentRequest);
  ...
  /**
     ...
     */
  _createClass(CreateReceivedDocumentRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('pending_id')) {
          obj.pending_id = _ApiClient["default"].convertToType(data.pending_id, 'Number');
        }
  ...
  return CreateReceivedDocumentRequest;
}();
/**
...
var _default = exports["default"] = CreateReceivedDocumentRequest;