 ...
 * @version 2.0.25
 */
var CreateVatTypeRequest = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>CreateVatTypeRequest</code>.
     * @alias module:model/CreateVatTypeRequest
     */
  function CreateVatTypeRequest() {
    _classCallCheck(this, CreateVatTypeRequest);
  ...
  /**
     ...
     */
  _createClass(CreateVatTypeRequest, null, [{
    key: "initialize",
    ...
    /**
       * Validates the JSON data with respect to <code>CreateVatTypeRequest</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateVatTypeRequest</code>.
       */
  }, {
    key: "validateJSON",
