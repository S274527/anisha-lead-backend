 ...
 * @module model/CreateVatTypeResponse
 * @version 2.0.25
 */
var CreateVatTypeResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>CreateVatTypeResponse</code>.
     * @alias module:model/CreateVatTypeResponse
     */
  function CreateVatTypeResponse() {
    _classCallCheck(this, CreateVatTypeResponse);
  ...
  /**
     ...
     */
  _createClass(CreateVatTypeResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _VatType["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>CreateVatTypeResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateVatTypeResponse</code>.
       */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _VatType["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = CreateVatTypeResponse;