 ...
 * @version 2.0.25
 */
var GetArchiveDocumentResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>GetArchiveDocumentResponse</code>.
     *
     * @alias module:model/GetArchiveDocumentResponse
     */
  function GetArchiveDocumentResponse() {
    _classCallCheck(this, GetArchiveDocumentResponse);
  ...
  /**
     ...
     */
  _createClass(GetArchiveDocumentResponse, null, [{
    key: "initialize",
    ...
    /**
       * Validates the JSON data with respect to <code>GetArchiveDocumentResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetArchiveDocumentResponse</code>.
       */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = GetArchiveDocumentResponse;