 ...
 * @version 2.0.25
 */
var GetCompanyInfoResponse = /*#__PURE__*/function () {
  /**
  ...
  function GetCompanyInfoResponse() {
    _classCallCheck(this, GetCompanyInfoResponse);
  ...
  /**
     ...
     */
  _createClass(GetCompanyInfoResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _CompanyInfo["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _CompanyInfo["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = GetCompanyInfoResponse;