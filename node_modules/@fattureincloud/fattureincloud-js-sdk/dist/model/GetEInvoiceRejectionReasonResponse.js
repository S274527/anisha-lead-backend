...
var _EInvoiceRejectionReason = _interopRequireDefault(require("./EInvoiceRejectionReason"));
 ...
 * @version 2.0.25
 */
var GetEInvoiceRejectionReasonResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>GetEInvoiceRejectionReasonResponse</code>.
     * @alias module:model/GetEInvoiceRejectionReasonResponse
     */
  function GetEInvoiceRejectionReasonResponse() {
    _classCallCheck(this, GetEInvoiceRejectionReasonResponse);
  ...
  /**
     ...
     */
  _createClass(GetEInvoiceRejectionReasonResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _EInvoiceRejectionReason["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _EInvoiceRejectionReason["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = GetEInvoiceRejectionReasonResponse;