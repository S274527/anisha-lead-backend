...
var _EmailData = _interopRequireDefault(require("./EmailData"));
 ...
 * @version 2.0.25
 */
var GetEmailDataResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>GetEmailDataResponse</code>.
     * @alias module:model/GetEmailDataResponse
     */
  function GetEmailDataResponse() {
    _classCallCheck(this, GetEmailDataResponse);
  ...
  /**
     ...
     */
  _createClass(GetEmailDataResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _EmailData["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _EmailData["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = GetEmailDataResponse;