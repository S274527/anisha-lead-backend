...
var _IssuedDocumentTotals = _interopRequireDefault(require("./IssuedDocumentTotals"));
 ...
 * @version 2.0.25
 */
var GetExistingIssuedDocumentTotalsResponse = /*#__PURE__*/function () {
  /**
     ...
     */
  function GetExistingIssuedDocumentTotalsResponse() {
    _classCallCheck(this, GetExistingIssuedDocumentTotalsResponse);
  ...
  /**
     ...
     */
  _createClass(GetExistingIssuedDocumentTotalsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _IssuedDocumentTotals["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _IssuedDocumentTotals["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = GetExistingIssuedDocumentTotalsResponse;