...
var _ReceivedDocumentTotals = _interopRequireDefault(require("./ReceivedDocumentTotals"));
 ...
 * @version 2.0.25
 */
var GetExistingReceivedDocumentTotalsResponse = /*#__PURE__*/function () {
  /**
     ...
     */
  function GetExistingReceivedDocumentTotalsResponse() {
    _classCallCheck(this, GetExistingReceivedDocumentTotalsResponse);
  ...
  /**
     ...
     */
  _createClass(GetExistingReceivedDocumentTotalsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ReceivedDocumentTotals["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _ReceivedDocumentTotals["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = GetExistingReceivedDocumentTotalsResponse;