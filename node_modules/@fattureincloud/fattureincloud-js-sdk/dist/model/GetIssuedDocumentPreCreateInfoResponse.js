...
var _IssuedDocumentPreCreateInfo = _interopRequireDefault(require("./IssuedDocumentPreCreateInfo"));
 ...
 * @version 2.0.25
 */
var GetIssuedDocumentPreCreateInfoResponse = /*#__PURE__*/function () {
  /**
     ...
     */
  function GetIssuedDocumentPreCreateInfoResponse() {
    _classCallCheck(this, GetIssuedDocumentPreCreateInfoResponse);
  ...
  /**
     ...
     */
  _createClass(GetIssuedDocumentPreCreateInfoResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _IssuedDocumentPreCreateInfo["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>GetIssuedDocumentPreCreateInfoResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetIssuedDocumentPreCreateInfoResponse</code>.
       */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _IssuedDocumentPreCreateInfo["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = GetIssuedDocumentPreCreateInfoResponse;