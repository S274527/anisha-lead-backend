...
var _ReceiptPreCreateInfo = _interopRequireDefault(require("./ReceiptPreCreateInfo"));
 ...
 * @version 2.0.25
 */
var GetReceiptPreCreateInfoResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>GetReceiptPreCreateInfoResponse</code>.
     *
     * @alias module:model/GetReceiptPreCreateInfoResponse
     */
  function GetReceiptPreCreateInfoResponse() {
    _classCallCheck(this, GetReceiptPreCreateInfoResponse);
  ...
  /**
     ...
     */
  _createClass(GetReceiptPreCreateInfoResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ReceiptPreCreateInfo["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>GetReceiptPreCreateInfoResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetReceiptPreCreateInfoResponse</code>.
       */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _ReceiptPreCreateInfo["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = GetReceiptPreCreateInfoResponse;