...
var _MonthlyTotal = _interopRequireDefault(require("./MonthlyTotal"));
 ...
 * @version 2.0.25
 */
var GetReceiptsMonthlyTotalsResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>GetReceiptsMonthlyTotalsResponse</code>.
     *
     * @alias module:model/GetReceiptsMonthlyTotalsResponse
     */
  function GetReceiptsMonthlyTotalsResponse() {
    _classCallCheck(this, GetReceiptsMonthlyTotalsResponse);
  ...
  /**
     ...
     */
  _createClass(GetReceiptsMonthlyTotalsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_MonthlyTotal["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _MonthlyTotal["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = GetReceiptsMonthlyTotalsResponse;