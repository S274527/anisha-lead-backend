...
var _ReceivedDocumentInfo = _interopRequireDefault(require("./ReceivedDocumentInfo"));
 ...
 * @version 2.0.25
 */
var GetReceivedDocumentPreCreateInfoResponse = /*#__PURE__*/function () {
  /**
     ...
     */
  function GetReceivedDocumentPreCreateInfoResponse() {
    _classCallCheck(this, GetReceivedDocumentPreCreateInfoResponse);
  ...
  /**
     ...
     */
  _createClass(GetReceivedDocumentPreCreateInfoResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ReceivedDocumentInfo["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _ReceivedDocumentInfo["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = GetReceivedDocumentPreCreateInfoResponse;