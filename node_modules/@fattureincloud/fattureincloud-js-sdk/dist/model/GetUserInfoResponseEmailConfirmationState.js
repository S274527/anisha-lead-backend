 ...
 * @version 2.0.25
 */
var GetUserInfoResponseEmailConfirmationState = /*#__PURE__*/function () {
  /**
     ...
     */
  function GetUserInfoResponseEmailConfirmationState() {
    _classCallCheck(this, GetUserInfoResponseEmailConfirmationState);
  ...
  /**
     ...
     */
  _createClass(GetUserInfoResponseEmailConfirmationState, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('need_confirmation')) {
          obj.need_confirmation = _ApiClient["default"].convertToType(data.need_confirmation, 'Boolean');
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>GetUserInfoResponseEmailConfirmationState</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUserInfoResponseEmailConfirmationState</code>.
       */
  }, {
    key: "validateJSON",
  ...
  return GetUserInfoResponseEmailConfirmationState;
}();
/**
 * @member {Boolean} need_confirmation
 */
GetUserInfoResponseEmailConfirmationState.prototype.need_confirmation = undefined;
var _default = exports["default"] = GetUserInfoResponseEmailConfirmationState;