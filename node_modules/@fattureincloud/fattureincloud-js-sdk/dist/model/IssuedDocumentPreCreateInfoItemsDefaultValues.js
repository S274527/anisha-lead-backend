 ...
 * @version 2.0.25
 */
var IssuedDocumentPreCreateInfoItemsDefaultValues = /*#__PURE__*/function () {
  /**
     ...
     */
  function IssuedDocumentPreCreateInfoItemsDefaultValues() {
    _classCallCheck(this, IssuedDocumentPreCreateInfoItemsDefaultValues);
  ...
  /**
     ...
     */
  _createClass(IssuedDocumentPreCreateInfoItemsDefaultValues, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('vat')) {
          obj.vat = _VatType["default"].constructFromObject(data.vat);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.vat) {
        // data not null
        _VatType["default"].validateJSON(data.vat);
      }
      return true;
    }
  }]);
  return IssuedDocumentPreCreateInfoItemsDefaultValues;
}();
/**
 * @member {module:model/VatType} vat
 */
IssuedDocumentPreCreateInfoItemsDefaultValues.prototype.vat = undefined;
var _default = exports["default"] = IssuedDocumentPreCreateInfoItemsDefaultValues;