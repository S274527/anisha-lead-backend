...
var _ArchiveDocument = _interopRequireDefault(require("./ArchiveDocument"));
var _ListArchiveDocumentsResponsePage = _interopRequireDefault(require("./ListArchiveDocumentsResponsePage"));
 ...
 * @version 2.0.25
 */
var ListArchiveDocumentsResponse = /*#__PURE__*/function () {
  /**
     ...
     */
  function ListArchiveDocumentsResponse() {
    _classCallCheck(this, ListArchiveDocumentsResponse);
    _Pagination["default"].initialize(this);
    _ListArchiveDocumentsResponsePage["default"].initialize(this);
  ...
  /**
     ...
     */
  _createClass(ListArchiveDocumentsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ListArchiveDocumentsResponsePage["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_ArchiveDocument["default"]]);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>ListArchiveDocumentsResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListArchiveDocumentsResponse</code>.
       */
  }, {
    key: "validateJSON",
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _ArchiveDocument["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
 ...
 * @member {Array.<module:model/ArchiveDocument>} data
 */
_ListArchiveDocumentsResponsePage["default"].prototype.data = undefined;
var _default = exports["default"] = ListArchiveDocumentsResponse;