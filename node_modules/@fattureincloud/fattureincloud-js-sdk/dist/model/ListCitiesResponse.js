 ...
 * @version 2.0.25
 */
var ListCitiesResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ListCitiesResponse</code>.
     *
     * @alias module:model/ListCitiesResponse
     */
  function ListCitiesResponse() {
    _classCallCheck(this, ListCitiesResponse);
  ...
  /**
     ...
     */
  _createClass(ListCitiesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_City["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _City["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListCitiesResponse;