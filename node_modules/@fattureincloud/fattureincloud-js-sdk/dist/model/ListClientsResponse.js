...
var _ListClientsResponsePage = _interopRequireDefault(require("./ListClientsResponsePage"));
 ...
 * @version 2.0.25
 */
var ListClientsResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListClientsResponse() {
    _classCallCheck(this, ListClientsResponse);
    _Pagination["default"].initialize(this);
    _ListClientsResponsePage["default"].initialize(this);
  ...
  /**
     ...
     */
  _createClass(ListClientsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ListClientsResponsePage["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_Client["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _Client["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
 ...
 * @member {Array.<module:model/Client>} data
 */
_ListClientsResponsePage["default"].prototype.data = undefined;
var _default = exports["default"] = ListClientsResponse;