 ...
 * @version 2.0.25
 */
var ListClientsResponsePage = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ListClientsResponsePage</code>.
     * @alias module:model/ListClientsResponsePage
     */
  function ListClientsResponsePage() {
    _classCallCheck(this, ListClientsResponsePage);
  ...
  /**
     ...
     */
  _createClass(ListClientsResponsePage, null, [{
    key: "initialize",
    ...
    /**
       * Validates the JSON data with respect to <code>ListClientsResponsePage</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListClientsResponsePage</code>.
       */
  }, {
    key: "validateJSON",
