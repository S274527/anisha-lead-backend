 ...
 * @version 2.0.25
 */
var ListCostCentersResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ListCostCentersResponse</code>.
     * @alias module:model/ListCostCentersResponse
     */
  function ListCostCentersResponse() {
    _classCallCheck(this, ListCostCentersResponse);
  ...
  /**
     ...
     */
  _createClass(ListCostCentersResponse, null, [{
    key: "initialize",
    ...
    /**
       * Validates the JSON data with respect to <code>ListCostCentersResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCostCentersResponse</code>.
       */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = ListCostCentersResponse;