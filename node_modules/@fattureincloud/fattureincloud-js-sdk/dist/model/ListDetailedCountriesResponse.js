...
var _DetailedCountry = _interopRequireDefault(require("./DetailedCountry"));
 ...
 * @version 2.0.25
 */
var ListDetailedCountriesResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ListDetailedCountriesResponse</code>.
     * @alias module:model/ListDetailedCountriesResponse
     */
  function ListDetailedCountriesResponse() {
    _classCallCheck(this, ListDetailedCountriesResponse);
  ...
  /**
     ...
     */
  _createClass(ListDetailedCountriesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_DetailedCountry["default"]]);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>ListDetailedCountriesResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDetailedCountriesResponse</code>.
       */
  }, {
    key: "validateJSON",
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _DetailedCountry["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListDetailedCountriesResponse;