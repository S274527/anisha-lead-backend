 ...
 * @version 2.0.25
 */
var ListEmailsResponsePage = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ListEmailsResponsePage</code>.
     * @alias module:model/ListEmailsResponsePage
     */
  function ListEmailsResponsePage() {
    _classCallCheck(this, ListEmailsResponsePage);
  ...
  /**
     ...
     */
  _createClass(ListEmailsResponsePage, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_Email["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _Email["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
