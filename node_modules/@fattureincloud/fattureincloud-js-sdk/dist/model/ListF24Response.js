...
var _F = _interopRequireDefault(require("./F24"));
var _ListF24ResponseAggregatedData = _interopRequireDefault(require("./ListF24ResponseAggregatedData"));
var _ListF24ResponseAggregation = _interopRequireDefault(require("./ListF24ResponseAggregation"));
var _ListF24ResponsePage = _interopRequireDefault(require("./ListF24ResponsePage"));
 ...
 * @version 2.0.25
 */
var ListF24Response = /*#__PURE__*/function () {
  /**
     ...
     */
  function ListF24Response() {
    _classCallCheck(this, ListF24Response);
    _Pagination["default"].initialize(this);
    _ListF24ResponsePage["default"].initialize(this);
    _ListF24ResponseAggregation["default"].initialize(this);
  ...
  /**
     ...
     */
  _createClass(ListF24Response, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ListF24ResponsePage["default"].constructFromObject(data, obj);
        _ListF24ResponseAggregation["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('last_page_url')) {
          obj.last_page_url = _ApiClient["default"].convertToType(data.last_page_url, 'String');
        }
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_F["default"]]);
        }
        if (data.hasOwnProperty('aggregated_data')) {
          obj.aggregated_data = _ListF24ResponseAggregatedData["default"].constructFromObject(data.aggregated_data);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.aggregated_data) {
        // data not null
        _ListF24ResponseAggregatedData["default"].validateJSON(data.aggregated_data);
      }
      return true;
    }
  }]);
 ...
 * @member {Number} current_page
 */
_Pagination["default"].prototype.current_page = undefined;
/**
 * First page url.
 * @member {String} first_page_url
 */
_Pagination["default"].prototype.first_page_url = undefined;
/**
 * First result of the page.
 * @member {Number} from
 */
_Pagination["default"].prototype.from = undefined;
/**
 * Last page number.
 * @member {Number} last_page
 */
_Pagination["default"].prototype.last_page = undefined;
/**
 * Last page url.
 * @member {String} last_page_url
 */
_Pagination["default"].prototype.last_page_url = undefined;
/**
 * Next page url
 * @member {String} next_page_url
 */
_Pagination["default"].prototype.next_page_url = undefined;
/**
 * Request path.
 * @member {String} path
 */
_Pagination["default"].prototype.path = undefined;
/**
 * Number of result per page.
 * @member {Number} per_page
 */
_Pagination["default"].prototype.per_page = undefined;
/**
 * Previous page url.
 * @member {String} prev_page_url
 */
_Pagination["default"].prototype.prev_page_url = undefined;
/**
 * Last result of the page.
 * @member {Number} to
 */
_Pagination["default"].prototype.to = undefined;
/**
 * Total number of results
 * @member {Number} total
 */
_Pagination["default"].prototype.total = undefined;
// Implement ListF24ResponsePage interface:
/**
 * @member {Array.<module:model/F24>} data
 */
_ListF24ResponsePage["default"].prototype.data = undefined;
// Implement ListF24ResponseAggregation interface:
/**
 * @member {module:model/ListF24ResponseAggregatedData} aggregated_data
 */
_ListF24ResponseAggregation["default"].prototype.aggregated_data = undefined;
var _default = exports["default"] = ListF24Response;