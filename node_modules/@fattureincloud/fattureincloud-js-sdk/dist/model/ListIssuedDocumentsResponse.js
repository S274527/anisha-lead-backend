...
var _IssuedDocument = _interopRequireDefault(require("./IssuedDocument"));
var _ListIssuedDocumentsResponsePage = _interopRequireDefault(require("./ListIssuedDocumentsResponsePage"));
 ...
 * @version 2.0.25
 */
var ListIssuedDocumentsResponse = /*#__PURE__*/function () {
  /**
     ...
     */
  function ListIssuedDocumentsResponse() {
    _classCallCheck(this, ListIssuedDocumentsResponse);
    _Pagination["default"].initialize(this);
    _ListIssuedDocumentsResponsePage["default"].initialize(this);
  ...
  /**
     ...
     */
  _createClass(ListIssuedDocumentsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ListIssuedDocumentsResponsePage["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_IssuedDocument["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _IssuedDocument["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
 ...
 * @member {Array.<module:model/IssuedDocument>} data
 */
_ListIssuedDocumentsResponsePage["default"].prototype.data = undefined;
var _default = exports["default"] = ListIssuedDocumentsResponse;