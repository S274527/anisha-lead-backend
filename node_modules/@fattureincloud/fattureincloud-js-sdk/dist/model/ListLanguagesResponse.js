 ...
 * @version 2.0.25
 */
var ListLanguagesResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListLanguagesResponse() {
    _classCallCheck(this, ListLanguagesResponse);
  ...
  /**
     ...
     */
  _createClass(ListLanguagesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_Language["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _Language["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListLanguagesResponse;