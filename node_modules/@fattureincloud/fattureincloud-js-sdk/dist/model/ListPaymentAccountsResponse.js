 ...
 * @version 2.0.25
 */
var ListPaymentAccountsResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ListPaymentAccountsResponse</code>.
     *
     * @alias module:model/ListPaymentAccountsResponse
     */
  function ListPaymentAccountsResponse() {
    _classCallCheck(this, ListPaymentAccountsResponse);
  ...
  /**
     ...
     */
  _createClass(ListPaymentAccountsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_PaymentAccount["default"]]);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>ListPaymentAccountsResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPaymentAccountsResponse</code>.
       */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = ListPaymentAccountsResponse;