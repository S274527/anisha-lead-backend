...
var _ListReceiptsResponsePage = _interopRequireDefault(require("./ListReceiptsResponsePage"));
 ...
 * @version 2.0.25
 */
var ListReceiptsResponse = /*#__PURE__*/function () {
  /**
     ...
     */
  function ListReceiptsResponse() {
    _classCallCheck(this, ListReceiptsResponse);
    _Pagination["default"].initialize(this);
    _ListReceiptsResponsePage["default"].initialize(this);
  ...
  /**
     ...
     */
  _createClass(ListReceiptsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ListReceiptsResponsePage["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_Receipt["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _Receipt["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
 ...
 * @member {Array.<module:model/Receipt>} data
 */
_ListReceiptsResponsePage["default"].prototype.data = undefined;
var _default = exports["default"] = ListReceiptsResponse;