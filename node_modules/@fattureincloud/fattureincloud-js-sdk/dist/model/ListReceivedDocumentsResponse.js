...
var _ListReceivedDocumentsResponsePage = _interopRequireDefault(require("./ListReceivedDocumentsResponsePage"));
var _Pagination = _interopRequireDefault(require("./Pagination"));
var _ReceivedDocument = _interopRequireDefault(require("./ReceivedDocument"));
 ...
 * @version 2.0.25
 */
var ListReceivedDocumentsResponse = /*#__PURE__*/function () {
  /**
     ...
     */
  function ListReceivedDocumentsResponse() {
    _classCallCheck(this, ListReceivedDocumentsResponse);
    _Pagination["default"].initialize(this);
    _ListReceivedDocumentsResponsePage["default"].initialize(this);
  ...
  /**
     ...
     */
  _createClass(ListReceivedDocumentsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ListReceivedDocumentsResponsePage["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_ReceivedDocument["default"]]);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>ListReceivedDocumentsResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListReceivedDocumentsResponse</code>.
       */
  }, {
    key: "validateJSON",
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _ReceivedDocument["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
 ...
 * @member {Array.<module:model/ReceivedDocument>} data
 */
_ListReceivedDocumentsResponsePage["default"].prototype.data = undefined;
var _default = exports["default"] = ListReceivedDocumentsResponse;