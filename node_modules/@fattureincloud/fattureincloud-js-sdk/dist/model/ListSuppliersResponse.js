...
var _ListSuppliersResponsePage = _interopRequireDefault(require("./ListSuppliersResponsePage"));
 ...
 * @version 2.0.25
 */
var ListSuppliersResponse = /*#__PURE__*/function () {
  /**
     ...
     */
  function ListSuppliersResponse() {
    _classCallCheck(this, ListSuppliersResponse);
    _Pagination["default"].initialize(this);
    _ListSuppliersResponsePage["default"].initialize(this);
  ...
  /**
     ...
     */
  _createClass(ListSuppliersResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ListSuppliersResponsePage["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_Supplier["default"]]);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>ListSuppliersResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSuppliersResponse</code>.
       */
  }, {
    key: "validateJSON",
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _Supplier["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
 ...
 * @member {Array.<module:model/Supplier>} data
 */
_ListSuppliersResponsePage["default"].prototype.data = undefined;
var _default = exports["default"] = ListSuppliersResponse;