 ...
 * @version 2.0.25
 */
var ListTemplatesResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListTemplatesResponse() {
    _classCallCheck(this, ListTemplatesResponse);
  ...
  /**
     ...
     */
  _createClass(ListTemplatesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_DocumentTemplate["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _DocumentTemplate["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListTemplatesResponse;