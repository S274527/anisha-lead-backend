...
var _ListUserCompaniesResponseData = _interopRequireDefault(require("./ListUserCompaniesResponseData"));
 ...
 * @version 2.0.25
 */
var ListUserCompaniesResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ListUserCompaniesResponse</code>.
     *
     * @alias module:model/ListUserCompaniesResponse
     */
  function ListUserCompaniesResponse() {
    _classCallCheck(this, ListUserCompaniesResponse);
  ...
  /**
     ...
     */
  _createClass(ListUserCompaniesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ListUserCompaniesResponseData["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>ListUserCompaniesResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUserCompaniesResponse</code>.
       */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _ListUserCompaniesResponseData["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = ListUserCompaniesResponse;