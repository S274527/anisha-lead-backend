 ...
 * @version 2.0.25
 */
var ListVatTypesResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ListVatTypesResponse</code>.
     *
     * @alias module:model/ListVatTypesResponse
     */
  function ListVatTypesResponse() {
    _classCallCheck(this, ListVatTypesResponse);
  ...
  /**
     ...
     */
  _createClass(ListVatTypesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _ApiClient["default"].convertToType(data.data, [_VatType["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data.data) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _VatType["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListVatTypesResponse;