 ...
 * @version 2.0.25
 */
var ModifyProductResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ModifyProductResponse</code>.
     * @alias module:model/ModifyProductResponse
     */
  function ModifyProductResponse() {
    _classCallCheck(this, ModifyProductResponse);
  ...
  /**
     ...
     */
  _createClass(ModifyProductResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _Product["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>ModifyProductResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModifyProductResponse</code>.
       */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _Product["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = ModifyProductResponse;