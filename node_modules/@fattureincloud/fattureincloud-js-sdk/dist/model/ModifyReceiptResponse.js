 ...
 * @version 2.0.25
 */
var ModifyReceiptResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ModifyReceiptResponse</code>.
     *
     * @alias module:model/ModifyReceiptResponse
     */
  function ModifyReceiptResponse() {
    _classCallCheck(this, ModifyReceiptResponse);
  ...
  /**
     ...
     */
  _createClass(ModifyReceiptResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _Receipt["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>ModifyReceiptResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModifyReceiptResponse</code>.
       */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _Receipt["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = ModifyReceiptResponse;