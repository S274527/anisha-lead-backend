 ...
 * @version 2.0.25
 */
var ModifyVatTypeRequest = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ModifyVatTypeRequest</code>.
     * @alias module:model/ModifyVatTypeRequest
     */
  function ModifyVatTypeRequest() {
    _classCallCheck(this, ModifyVatTypeRequest);
  ...
  /**
     ...
     */
  _createClass(ModifyVatTypeRequest, null, [{
    key: "initialize",
    ...
    /**
       * Validates the JSON data with respect to <code>ModifyVatTypeRequest</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModifyVatTypeRequest</code>.
       */
  }, {
    key: "validateJSON",
