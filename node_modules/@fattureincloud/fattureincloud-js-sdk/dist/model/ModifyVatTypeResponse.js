 ...
 * @version 2.0.25
 */
var ModifyVatTypeResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ModifyVatTypeResponse</code>.
     * @alias module:model/ModifyVatTypeResponse
     */
  function ModifyVatTypeResponse() {
    _classCallCheck(this, ModifyVatTypeResponse);
  ...
  /**
     ...
     */
  _createClass(ModifyVatTypeResponse, null, [{
    key: "initialize",
    ...
    /**
       * Validates the JSON data with respect to <code>ModifyVatTypeResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModifyVatTypeResponse</code>.
       */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = ModifyVatTypeResponse;