...
var MonthlyTotal = /*#__PURE__*/function () {
  ...
  /**
     ...
     */
  _createClass(MonthlyTotal, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('net')) {
          obj.net = _ApiClient["default"].convertToType(data.net, 'Number');
        }
        if (data.hasOwnProperty('gross')) {
          obj.gross = _ApiClient["default"].convertToType(data.gross, 'Number');
        }
    ...
    /**
       * Validates the JSON data with respect to <code>MonthlyTotal</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MonthlyTotal</code>.
       */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = MonthlyTotal;