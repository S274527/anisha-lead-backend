...
var _PermissionLevel = _interopRequireDefault(require("./PermissionLevel"));
var _PermissionsFicIssuedDocumentsDetailed = _interopRequireDefault(require("./PermissionsFicIssuedDocumentsDetailed"));
...
var Permissions = /*#__PURE__*/function () {
  ...
  _createClass(Permissions, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('fic_situation')) {
          obj.fic_situation = _PermissionLevel["default"].constructFromObject(data.fic_situation);
        }
        if (data.hasOwnProperty('fic_clients')) {
          obj.fic_clients = _PermissionLevel["default"].constructFromObject(data.fic_clients);
        }
        if (data.hasOwnProperty('fic_suppliers')) {
          obj.fic_suppliers = _PermissionLevel["default"].constructFromObject(data.fic_suppliers);
        }
        if (data.hasOwnProperty('fic_products')) {
          obj.fic_products = _PermissionLevel["default"].constructFromObject(data.fic_products);
        }
        if (data.hasOwnProperty('fic_issued_documents')) {
          obj.fic_issued_documents = _PermissionLevel["default"].constructFromObject(data.fic_issued_documents);
        }
        if (data.hasOwnProperty('fic_received_documents')) {
          obj.fic_received_documents = _PermissionLevel["default"].constructFromObject(data.fic_received_documents);
        }
        if (data.hasOwnProperty('fic_receipts')) {
          obj.fic_receipts = _PermissionLevel["default"].constructFromObject(data.fic_receipts);
        }
        if (data.hasOwnProperty('fic_calendar')) {
          obj.fic_calendar = _PermissionLevel["default"].constructFromObject(data.fic_calendar);
        }
        if (data.hasOwnProperty('fic_archive')) {
          obj.fic_archive = _PermissionLevel["default"].constructFromObject(data.fic_archive);
        }
        if (data.hasOwnProperty('fic_taxes')) {
          obj.fic_taxes = _PermissionLevel["default"].constructFromObject(data.fic_taxes);
        }
        if (data.hasOwnProperty('fic_stock')) {
          obj.fic_stock = _PermissionLevel["default"].constructFromObject(data.fic_stock);
        }
        if (data.hasOwnProperty('fic_cashbook')) {
          obj.fic_cashbook = _PermissionLevel["default"].constructFromObject(data.fic_cashbook);
        }
        if (data.hasOwnProperty('fic_settings')) {
          obj.fic_settings = _PermissionLevel["default"].constructFromObject(data.fic_settings);
        }
        if (data.hasOwnProperty('fic_emails')) {
          obj.fic_emails = _PermissionLevel["default"].constructFromObject(data.fic_emails);
        }
        if (data.hasOwnProperty('fic_export')) {
          obj.fic_export = _PermissionLevel["default"].constructFromObject(data.fic_export);
        }
        if (data.hasOwnProperty('fic_import_bankstatements')) {
          obj.fic_import_bankstatements = _PermissionLevel["default"].constructFromObject(data.fic_import_bankstatements);
        }
        if (data.hasOwnProperty('fic_import_clients_suppliers')) {
          obj.fic_import_clients_suppliers = _PermissionLevel["default"].constructFromObject(data.fic_import_clients_suppliers);
        }
        if (data.hasOwnProperty('fic_import_issued_documents')) {
          obj.fic_import_issued_documents = _PermissionLevel["default"].constructFromObject(data.fic_import_issued_documents);
        }
        if (data.hasOwnProperty('fic_import_products')) {
          obj.fic_import_products = _PermissionLevel["default"].constructFromObject(data.fic_import_products);
        }
        if (data.hasOwnProperty('fic_recurring')) {
          obj.fic_recurring = _PermissionLevel["default"].constructFromObject(data.fic_recurring);
        }
        if (data.hasOwnProperty('fic_riba')) {
          obj.fic_riba = _PermissionLevel["default"].constructFromObject(data.fic_riba);
        }
        if (data.hasOwnProperty('dic_employees')) {
          obj.dic_employees = _PermissionLevel["default"].constructFromObject(data.dic_employees);
        }
        if (data.hasOwnProperty('dic_settings')) {
          obj.dic_settings = _PermissionLevel["default"].constructFromObject(data.dic_settings);
        }
        if (data.hasOwnProperty('dic_timesheet')) {
          obj.dic_timesheet = _PermissionLevel["default"].constructFromObject(data.dic_timesheet);
        }
        if (data.hasOwnProperty('fic_issued_documents_detailed')) {
          obj.fic_issued_documents_detailed = _PermissionsFicIssuedDocumentsDetailed["default"].constructFromObject(data.fic_issued_documents_detailed);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.fic_issued_documents_detailed) {
        // data not null
        _PermissionsFicIssuedDocumentsDetailed["default"].validateJSON(data.fic_issued_documents_detailed);
      }
      return true;
    }
  }]);
