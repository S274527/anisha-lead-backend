...
var _PaymentAccount = _interopRequireDefault(require("./PaymentAccount"));
 ...
 * @version 2.0.25
 */
var ReceiptPreCreateInfo = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ReceiptPreCreateInfo</code>.
     * @alias module:model/ReceiptPreCreateInfo
     */
  function ReceiptPreCreateInfo() {
    _classCallCheck(this, ReceiptPreCreateInfo);
  ...
  /**
     ...
     */
  _createClass(ReceiptPreCreateInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('numerations')) {
          obj.numerations = _ApiClient["default"].convertToType(data.numerations, {
            String: Object
          });
        }
        if (data.hasOwnProperty('numerations_list')) {
          obj.numerations_list = _ApiClient["default"].convertToType(data.numerations_list, ['String']);
        }
        if (data.hasOwnProperty('rc_centers_list')) {
          obj.rc_centers_list = _ApiClient["default"].convertToType(data.rc_centers_list, ['String']);
        }
        if (data.hasOwnProperty('payment_accounts_list')) {
          obj.payment_accounts_list = _ApiClient["default"].convertToType(data.payment_accounts_list, [_PaymentAccount["default"]]);
        }
        if (data.hasOwnProperty('categories_list')) {
          obj.categories_list = _ApiClient["default"].convertToType(data.categories_list, ['String']);
        }
        if (data.hasOwnProperty('vat_types_list')) {
          obj.vat_types_list = _ApiClient["default"].convertToType(data.vat_types_list, [_VatType["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.payment_accounts_list) {
        ...
        var _iterator = _createForOfIteratorHelper(data.payment_accounts_list),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _PaymentAccount["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data.vat_types_list) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data.vat_types_list),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var _item = _step2.value;
            _VatType["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = ReceiptPreCreateInfo;