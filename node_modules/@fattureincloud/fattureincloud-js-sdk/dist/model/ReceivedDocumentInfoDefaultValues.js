 ...
 * @version 2.0.25
 */
var ReceivedDocumentInfoDefaultValues = /*#__PURE__*/function () {
  /**
     ...
     */
  function ReceivedDocumentInfoDefaultValues() {
    _classCallCheck(this, ReceivedDocumentInfoDefaultValues);
  ...
  /**
     ...
     */
  _createClass(ReceivedDocumentInfoDefaultValues, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('detailed')) {
          obj.detailed = _ApiClient["default"].convertToType(data.detailed, 'Boolean');
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>ReceivedDocumentInfoDefaultValues</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReceivedDocumentInfoDefaultValues</code>.
       */
  }, {
    key: "validateJSON",
  ...
  return ReceivedDocumentInfoDefaultValues;
}();
/**
 * @member {Boolean} detailed
 */
ReceivedDocumentInfoDefaultValues.prototype.detailed = undefined;
var _default = exports["default"] = ReceivedDocumentInfoDefaultValues;