 ...
 * @version 2.0.25
 */
var ReceivedDocumentInfoItemsDefaultValues = /*#__PURE__*/function () {
  /**
     ...
     */
  function ReceivedDocumentInfoItemsDefaultValues() {
    _classCallCheck(this, ReceivedDocumentInfoItemsDefaultValues);
  ...
  /**
     ...
     */
  _createClass(ReceivedDocumentInfoItemsDefaultValues, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('vat')) {
          obj.vat = _ApiClient["default"].convertToType(data.vat, 'Number');
        }
      }
      return obj;
    }
  ...
  return ReceivedDocumentInfoItemsDefaultValues;
}();
/**
 * Vat default value
 * @member {Number} vat
...
var _default = exports["default"] = ReceivedDocumentInfoItemsDefaultValues;