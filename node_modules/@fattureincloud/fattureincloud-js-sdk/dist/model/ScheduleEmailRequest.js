...
var _EmailSchedule = _interopRequireDefault(require("./EmailSchedule"));
 ...
 * @version 2.0.25
 */
var ScheduleEmailRequest = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ScheduleEmailRequest</code>.
     *
     * @alias module:model/ScheduleEmailRequest
     */
  function ScheduleEmailRequest() {
    _classCallCheck(this, ScheduleEmailRequest);
  ...
  /**
     ...
     */
  _createClass(ScheduleEmailRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _EmailSchedule["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>ScheduleEmailRequest</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleEmailRequest</code>.
       */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _EmailSchedule["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = ScheduleEmailRequest;