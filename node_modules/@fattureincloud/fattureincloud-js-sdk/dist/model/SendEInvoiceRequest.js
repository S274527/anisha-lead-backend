...
var _SendEInvoiceRequestData = _interopRequireDefault(require("./SendEInvoiceRequestData"));
var _SendEInvoiceRequestOptions = _interopRequireDefault(require("./SendEInvoiceRequestOptions"));
 ...
 * @version 2.0.25
 */
var SendEInvoiceRequest = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>SendEInvoiceRequest</code>.
     * @alias module:model/SendEInvoiceRequest
     */
  function SendEInvoiceRequest() {
    _classCallCheck(this, SendEInvoiceRequest);
  ...
  /**
     ...
     */
  _createClass(SendEInvoiceRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _SendEInvoiceRequestData["default"].constructFromObject(data.data);
        }
        if (data.hasOwnProperty('options')) {
          obj.options = _SendEInvoiceRequestOptions["default"].constructFromObject(data.options);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _SendEInvoiceRequestData["default"].validateJSON(data.data);
      }
      // validate the optional field `options`
      if (data.options) {
        // data not null
        _SendEInvoiceRequestOptions["default"].validateJSON(data.options);
      }
      return true;
    }
  }]);
  return SendEInvoiceRequest;
}();
/**
...
var _default = exports["default"] = SendEInvoiceRequest;