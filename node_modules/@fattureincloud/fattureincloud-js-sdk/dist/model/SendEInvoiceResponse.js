...
var _SendEInvoiceResponseData = _interopRequireDefault(require("./SendEInvoiceResponseData"));
 ...
 * @version 2.0.25
 */
var SendEInvoiceResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>SendEInvoiceResponse</code>.
     * @alias module:model/SendEInvoiceResponse
     */
  function SendEInvoiceResponse() {
    _classCallCheck(this, SendEInvoiceResponse);
  ...
  /**
     ...
     */
  _createClass(SendEInvoiceResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _SendEInvoiceResponseData["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    /**
       * Validates the JSON data with respect to <code>SendEInvoiceResponse</code>.
       * @param {Object} data The plain JavaScript object bearing properties of interest.
       * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendEInvoiceResponse</code>.
       */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _SendEInvoiceResponseData["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = SendEInvoiceResponse;