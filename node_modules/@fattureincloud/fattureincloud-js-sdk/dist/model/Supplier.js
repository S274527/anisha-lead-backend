...
var _SupplierType = _interopRequireDefault(require("./SupplierType"));
 ...
 * @version 2.0.25
 */
var Supplier = /*#__PURE__*/function () {
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('type')) {
          obj.type = _SupplierType["default"].constructFromObject(data.type);
        }
