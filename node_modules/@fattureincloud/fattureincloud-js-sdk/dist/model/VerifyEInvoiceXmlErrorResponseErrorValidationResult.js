 ...
 * @version 2.0.25
 */
var VerifyEInvoiceXmlErrorResponseErrorValidationResult = /*#__PURE__*/function () {
  /**
     ...
     */
  function VerifyEInvoiceXmlErrorResponseErrorValidationResult() {
    _classCallCheck(this, VerifyEInvoiceXmlErrorResponseErrorValidationResult);
  ...
  /**
     ...
     */
  _createClass(VerifyEInvoiceXmlErrorResponseErrorValidationResult, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('xml_errors')) {
          obj.xml_errors = _ApiClient["default"].convertToType(data.xml_errors, ['String']);
        }
      }
      return obj;
    }
  ...
  return VerifyEInvoiceXmlErrorResponseErrorValidationResult;
}();
/**
 * @member {Array.<String>} xml_errors
 */
VerifyEInvoiceXmlErrorResponseErrorValidationResult.prototype.xml_errors = undefined;
var _default = exports["default"] = VerifyEInvoiceXmlErrorResponseErrorValidationResult;