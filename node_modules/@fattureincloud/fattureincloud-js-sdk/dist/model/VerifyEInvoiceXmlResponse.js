...
var _VerifyEInvoiceXmlResponseData = _interopRequireDefault(require("./VerifyEInvoiceXmlResponseData"));
 ...
 * @version 2.0.25
 */
var VerifyEInvoiceXmlResponse = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>VerifyEInvoiceXmlResponse</code>.
     * @alias module:model/VerifyEInvoiceXmlResponse
     */
  function VerifyEInvoiceXmlResponse() {
    _classCallCheck(this, VerifyEInvoiceXmlResponse);
  ...
  /**
     ...
     */
  _createClass(VerifyEInvoiceXmlResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj.data = _VerifyEInvoiceXmlResponseData["default"].constructFromObject(data.data);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.data) {
        // data not null
        _VerifyEInvoiceXmlResponseData["default"].validateJSON(data.data);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = VerifyEInvoiceXmlResponse;